...
# 📖 Awesome-booksEs6 <a name="about-project"></a>

> A book app that adds and deletes books from the list.

**[Awesome-booksEs6]** is a project that adds and deletes books from the list.
...
- use the git clone command with this [link](git@github.com:Lornakaboro/Awesome-booksEs6.git)
- cd into Awesome-booksEs6
- Switch branch using this command `git checkout awesome-booksEs6`
- Open index.html in your browser
- You will be able to see a  simple web page that adds and deletes books from the list and a contact page.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
<!-- AUTHORS -->
